...
public class OrdersService {
	...
	@Transactional
	public OrdersCreatResponsDto creatOrders(OrdersCreatRequestDto requestDto, User user){
		...
		// 응답 DTO 반환
		return new OrdersCreatResponsDto(order.getId(), order.getOrderItems().size());
